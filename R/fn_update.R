...
#' @description update_intv_rcps_per_OOS() is an Update function that edits an object, while preserving core object attributes. Specifically, this function implements an algorithm to update intervention recipients per occasion of service. Function argument main_calcs_tb specifies the object to be updated. The function is called for its side effects and does not return a value.
...
#' @description update_resc_use_tb_for_gndr_diffs() is an Update function that edits an object, while preserving core object attributes. Specifically, this function implements an algorithm to update resource use tibble for gender differences. Function argument resource_use_tb specifies the object to be updated. Argument fem_uids_chr provides the object to be updated. The function returns Resource use (a tibble).
