#' Format bound resource
#' @description format_bound_resc_tb() is a Format function that binds two instances of a data-frame type class together. Specifically, this function implements an algorithm to format bound resource tibble. The function returns Bound resource (a tibble).
