...
pkg_dss_tb <- fns_dmt_tb %>%
  ready4fun::write_and_doc_ds(db_1L_chr = "fns_dmt_tb",
                              title_1L_chr = "bimp function documentation table",
                              desc_1L_chr = "Meta-data on each bimp function used to create package documentation",
                              url_1L_chr = "https://ready4-dev.github.io/bimp/",
                              abbreviations_lup = abbreviations_lup,
                              pkg_dss_tb = pkg_dss_tb)
